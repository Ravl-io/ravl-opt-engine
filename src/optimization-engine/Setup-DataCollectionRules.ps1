...
.DESCRIPTION
This script deploys Data Collection Rules (DCRs) to collect performance counters from Windows and Linux virtual machines required by the RAVLs Optimization Engine
