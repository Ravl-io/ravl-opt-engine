# 📒 RAVLs Optimization Engine workbooks

This folder contains the several ROE workbooks reports that leverage the collected data and generated recommendations. Each Workbook is made of a JSON file, where the actual Workbook code is specified, and a Bicep file, which encapsulates the Workbook definition for deployment purposes:
...
- Governance
    ...
    - [Recommendations](./recommendations.json): reports on the optimization recommendations generated every week by both ROE and Azure Advisor, across the five pillars of the Well Architected Framework - Cost, Operational Excellence, Performance, Reliability, and Security.
