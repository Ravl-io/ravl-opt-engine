<#
.SYNOPSIS
This script suppresses a recommendation in the RAVLs Optimization Engine.

.DESCRIPTION
This script suppresses a recommendation in the RAVLs Optimization Engine. The script will prompt the user for the required information
...
.LINK
https://github.com/Ravl-io/ravl-opt-engine/suppressrecs
#>
param(
...
{
    $databaseServer = Read-Host "Please, enter the ROE Azure SQL server hostname (for example, xpto.database.windows.net)"
...
{
    $databaseName = Read-Host "Please, enter the ROE Azure SQL Database name (for example, azureoptimization)"
