...
// AWS Data Collection export/ingest job IDs
param awsEC2ExportJobId string = newGuid()
param awsEC2IngestJobId string = newGuid()
param awsEBSUnattachedExportJobId string = newGuid()
param awsEBSUnattachedIngestJobId string = newGuid()
param awsEBSUnderutilizedExportJobId string = newGuid()
param awsEBSUnderutilizedIngestJobId string = newGuid()
param awsEIPExportJobId string = newGuid()
param awsEIPIngestJobId string = newGuid()
param awsRDSExportJobId string = newGuid()
param awsRDSIngestJobId string = newGuid()
param awsLBExportJobId string = newGuid()
param awsLBIngestJobId string = newGuid()
param awsLambdaExportJobId string = newGuid()
param awsLambdaIngestJobId string = newGuid()
param awsECSExportJobId string = newGuid()
param awsECSIngestJobId string = newGuid()
param awsElasticBeanstalkExportJobId string = newGuid()
param awsElasticBeanstalkIngestJobId string = newGuid()
param awsBucketsExportJobId string = newGuid()
param awsBucketsIngestJobId string = newGuid()

// GCP Data Collection export/ingest job IDs
param gcpVMsExportJobId string = newGuid()
param gcpVMsIngestJobId string = newGuid()
param gcpVMsOffHoursExportJobId string = newGuid()
param gcpVMsOffHoursIngestJobId string = newGuid()
param gcpIdleDisksExportJobId string = newGuid()
param gcpIdleDisksIngestJobId string = newGuid()
param gcpUnderutilizedDisksExportJobId string = newGuid()
param gcpUnderutilizedDisksIngestJobId string = newGuid()
param gcpUnmanagedDisksExportJobId string = newGuid()
param gcpUnmanagedDisksIngestJobId string = newGuid()
param gcpIdleServicesExportJobId string = newGuid()
param gcpIdleServicesIngestJobId string = newGuid()
param gcpUnattachedIPsExportJobId string = newGuid()
param gcpUnattachedIPsIngestJobId string = newGuid()
param gcpSQLExportJobId string = newGuid()
param gcpSQLIngestJobId string = newGuid()
param gcpBucketsExportJobId string = newGuid()
param gcpBucketsIngestJobId string = newGuid()
param gcpLBExportJobId string = newGuid()
param gcpLBIngestJobId string = newGuid()
param gcpFOCUSIngestJobId string = newGuid()

// New Azure export job IDs
param vmOffHoursExportJobId string = newGuid()
param vmOffHoursIngestJobId string = newGuid()

// AWS Recommendation job IDs
param awsEC2RecommendationJobId string = newGuid()
param awsEBSUnattachedRecommendationJobId string = newGuid()
param awsEBSUnderutilizedRecommendationJobId string = newGuid()
param awsEIPRecommendationJobId string = newGuid()
param awsRDSRecommendationJobId string = newGuid()
param awsLBRecommendationJobId string = newGuid()
param awsLambdaRecommendationJobId string = newGuid()
param awsECSRecommendationJobId string = newGuid()
param awsElasticBeanstalkRecommendationJobId string = newGuid()
param awsBucketsRecommendationJobId string = newGuid()

// GCP Recommendation job IDs
param gcpVMsRecommendationJobId string = newGuid()
param gcpVMsOffHoursRecommendationJobId string = newGuid()
param gcpIdleDisksRecommendationJobId string = newGuid()
param gcpUnderutilizedDisksRecommendationJobId string = newGuid()
param gcpSQLRecommendationJobId string = newGuid()
param gcpIdleServicesRecommendationJobId string = newGuid()
param gcpUnattachedIPsRecommendationJobId string = newGuid()
param gcpLBRecommendationJobId string = newGuid()
param gcpBucketsRecommendationJobId string = newGuid()

// New Azure Recommendation job IDs
param underutilizedVMsRecommendationJobId string = newGuid()
param unmanagedDisksRecommendationJobId string = newGuid()
param vmOffHoursRecommendationJobId string = newGuid()
...
// New Azure export runbook names
var vmOffHoursExportsRunbookName = 'Export-VMsUnderutilizedOffHoursToBlobStorage'
// AWS Data Collection runbook names
var awsEC2ExportsRunbookName = 'Export-AWSUnderutilizedEC2Instances'
var awsEBSUnattachedExportsRunbookName = 'Export-AWSUnattachedEBSVolumes'
var awsEBSUnderutilizedExportsRunbookName = 'Export-AWSUnderutilizedEBSVolumes'
var awsEIPExportsRunbookName = 'Export-AWSUnattachedEIPs'
var awsRDSExportsRunbookName = 'Export-AWSUnderutilizedRDSInstances'
var awsLBExportsRunbookName = 'Export-AWSUnderutilizedLoadBalancers'
var awsLambdaExportsRunbookName = 'Export-AWSIdleLambdaFunctions'
var awsECSExportsRunbookName = 'Export-AWSIdleECSServices'
var awsElasticBeanstalkExportsRunbookName = 'Export-AWSIdleElasticBeanstalkEnvironments'
var awsBucketsExportsRunbookName = 'Export-AWSbucketsWithoutRetention'
// GCP Data Collection runbook names
var gcpVMsExportsRunbookName = 'Export-GCPUnderutilizedVMs'
var gcpVMsOffHoursExportsRunbookName = 'Export-GCPUnderutilizedVMsOffHours'
var gcpIdleDisksExportsRunbookName = 'Export-GCPidleDisks'
var gcpUnderutilizedDisksExportsRunbookName = 'Export-GCPunderutilizedDisks'
var gcpUnmanagedDisksExportsRunbookName = 'Export-GCPunmanagedDisks'
var gcpIdleServicesExportsRunbookName = 'Export-GCPIdleServices'
var gcpUnattachedIPsExportsRunbookName = 'Export-GCPUnattachedIPs'
var gcpSQLExportsRunbookName = 'Export-GCPunderutilizedSQL'
var gcpBucketsExportsRunbookName = 'Export-GCPbucketsWithoutRetention'
var gcpLBExportsRunbookName = 'Export-GCPunusedLoadBalancers'
var gcpFOCUSIngestRunbookName = 'GCP-IngestFOCUS'
// AWS Recommendation runbook names
var awsEC2RecommendationsRunbookName = 'Recommend-AWSUnderutilizedEC2Instances'
var awsEBSUnattachedRecommendationsRunbookName = 'Recommend-AWSUnattachedEBSVolumes'
var awsEBSUnderutilizedRecommendationsRunbookName = 'Recommend-AWSUnderutilizedEBSVolumes'
var awsEIPRecommendationsRunbookName = 'Recommend-AWSUnattachedEIPs'
var awsRDSRecommendationsRunbookName = 'Recommend-AWSUnderutilizedRDSInstances'
var awsLBRecommendationsRunbookName = 'Recommend-AWSUnderutilizedLoadBalancers'
var awsLambdaRecommendationsRunbookName = 'Recommend-AWSIdleLambdaFunctions'
var awsECSRecommendationsRunbookName = 'Recommend-AWSIdleECSServices'
var awsElasticBeanstalkRecommendationsRunbookName = 'Recommend-AWSIdleElasticBeanstalkEnvironments'
var awsBucketsRecommendationsRunbookName = 'Recommend-AWSBucketsWithoutRetention'
// GCP Recommendation runbook names
var gcpVMsRecommendationsRunbookName = 'Recommend-GCPUnderutilizedVMs'
var gcpVMsOffHoursRecommendationsRunbookName = 'Recommend-GCPUnderutilizedVMsOffHours'
var gcpIdleDisksRecommendationsRunbookName = 'Recommend-GCPidleDisks'
var gcpUnderutilizedDisksRecommendationsRunbookName = 'Recommend-GCPUnderutilizedDisks'
var gcpSQLRecommendationsRunbookName = 'Recommend-GCPUnderutilizedCloudSQL'
var gcpIdleServicesRecommendationsRunbookName = 'Recommend-GCPIdleServices'
var gcpUnattachedIPsRecommendationsRunbookName = 'Recommend-GCPUnattachedIPs'
var gcpLBRecommendationsRunbookName = 'Recommend-GCPUnusedLoadBalancers'
var gcpBucketsRecommendationsRunbookName = 'Recommend-BucketsWithoutRetention'
// New Azure Recommendation runbook names
var underutilizedVMsRecommendationsRunbookName = 'Recommend-UnderutilizedVMs'
var unmanagedDisksRecommendationsRunbookName = 'Recommend-UnmanagedDisks'
var vmOffHoursRecommendationsRunbookName = 'Recommend-VMsUnderutilizedOffHoursToBlobStorage'
// Orchestrator runbook name
var distributorOrchestratorRunbookName = 'Trigger-OptimizationEngineDistributor'
// New Azure export schedule names
var vmOffHoursExportsScheduleName = 'AzureOptimization_ExportVMsOffHoursDaily'
// AWS schedule names
var awsEC2ExportsScheduleName = 'AzureOptimization_ExportAWSEC2Schedule'
var awsEBSUnattachedExportsScheduleName = 'AzureOptimization_ExportAWSEBSUnattachedSchedule'
var awsEBSUnderutilizedExportsScheduleName = 'AzureOptimization_ExportAWSEBSUnderutilizedSchedule'
var awsEIPExportsScheduleName = 'AzureOptimization_ExportAWSEIPSchedule'
var awsRDSExportsScheduleName = 'AzureOptimization_ExportAWSRDSSchedule'
var awsLBExportsScheduleName = 'AzureOptimization_ExportAWSLBSchedule'
var awsLambdaExportsScheduleName = 'AzureOptimization_ExportAWSLambdaSchedule'
var awsECSExportsScheduleName = 'AzureOptimization_ExportAWSECSSchedule'
var awsElasticBeanstalkExportsScheduleName = 'AzureOptimization_ExportAWSElasticBeanstalkSchedule'
var awsBucketsExportsScheduleName = 'AzureOptimization_ExportAWSBucketsSchedule'
// GCP schedule names
var gcpVMsExportsScheduleName = 'AzureOptimization_ExportGCPVMsSchedule'
var gcpVMsOffHoursExportsScheduleName = 'AzureOptimization_ExportGCPVMsOffHoursSchedule'
var gcpIdleDisksExportsScheduleName = 'AzureOptimization_ExportGCPIdleDisksSchedule'
var gcpUnderutilizedDisksExportsScheduleName = 'AzureOptimization_ExportGCPUnderutilizedDisksSchedule'
var gcpUnmanagedDisksExportsScheduleName = 'AzureOptimization_ExportGCPUnmanagedDisksSchedule'
var gcpIdleServicesExportsScheduleName = 'AzureOptimization_ExportGCPIdleServicesSchedule'
var gcpUnattachedIPsExportsScheduleName = 'AzureOptimization_ExportGCPUnattachedIPsSchedule'
var gcpSQLExportsScheduleName = 'AzureOptimization_ExportGCPSQLSchedule'
var gcpBucketsExportsScheduleName = 'AzureOptimization_ExportGCPBucketsSchedule'
var gcpLBExportsScheduleName = 'AzureOptimization_ExportGCPLBSchedule'
var gcpFOCUSIngestScheduleName = 'AzureOptimization_IngestGCPFOCUSSchedule'
...
var csvExportsSchedules = [
  ...
  // New Azure export schedule
  {
    exportSchedule: vmOffHoursExportsScheduleName
    exportDescription: 'Daily VM off-hours underutilization exports'
    exportTimeOffset: 'PT1H38M'
    exportFrequency: 'Day'
  }
  // AWS export schedules (disabled by default)
  {
    exportSchedule: awsEC2ExportsScheduleName
    exportDescription: 'Daily AWS EC2 underutilized instances exports'
    exportTimeOffset: 'PT3H00M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsEBSUnattachedExportsScheduleName
    exportDescription: 'Daily AWS unattached EBS volumes exports'
    exportTimeOffset: 'PT3H01M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsEBSUnderutilizedExportsScheduleName
    exportDescription: 'Daily AWS underutilized EBS volumes exports'
    exportTimeOffset: 'PT3H02M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsEIPExportsScheduleName
    exportDescription: 'Daily AWS unattached EIPs exports'
    exportTimeOffset: 'PT3H03M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsRDSExportsScheduleName
    exportDescription: 'Daily AWS underutilized RDS instances exports'
    exportTimeOffset: 'PT3H04M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsLBExportsScheduleName
    exportDescription: 'Daily AWS underutilized Load Balancers exports'
    exportTimeOffset: 'PT3H05M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsLambdaExportsScheduleName
    exportDescription: 'Daily AWS idle Lambda functions exports'
    exportTimeOffset: 'PT3H06M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsECSExportsScheduleName
    exportDescription: 'Daily AWS idle ECS services exports'
    exportTimeOffset: 'PT3H07M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsElasticBeanstalkExportsScheduleName
    exportDescription: 'Daily AWS idle Elastic Beanstalk environments exports'
    exportTimeOffset: 'PT3H08M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: awsBucketsExportsScheduleName
    exportDescription: 'Daily AWS buckets without retention exports'
    exportTimeOffset: 'PT3H09M'
    exportFrequency: 'Day'
  }
  // GCP export schedules (disabled by default)
  {
    exportSchedule: gcpVMsExportsScheduleName
    exportDescription: 'Daily GCP underutilized VMs exports'
    exportTimeOffset: 'PT4H00M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpVMsOffHoursExportsScheduleName
    exportDescription: 'Daily GCP underutilized VMs off-hours exports'
    exportTimeOffset: 'PT4H01M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpIdleDisksExportsScheduleName
    exportDescription: 'Daily GCP idle disks exports'
    exportTimeOffset: 'PT4H02M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpUnderutilizedDisksExportsScheduleName
    exportDescription: 'Daily GCP underutilized disks exports'
    exportTimeOffset: 'PT4H03M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpUnmanagedDisksExportsScheduleName
    exportDescription: 'Daily GCP unmanaged disks exports'
    exportTimeOffset: 'PT4H04M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpIdleServicesExportsScheduleName
    exportDescription: 'Daily GCP idle services exports'
    exportTimeOffset: 'PT4H05M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpUnattachedIPsExportsScheduleName
    exportDescription: 'Daily GCP unattached IPs exports'
    exportTimeOffset: 'PT4H06M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpSQLExportsScheduleName
    exportDescription: 'Daily GCP underutilized Cloud SQL exports'
    exportTimeOffset: 'PT4H07M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpBucketsExportsScheduleName
    exportDescription: 'Daily GCP buckets without retention exports'
    exportTimeOffset: 'PT4H08M'
    exportFrequency: 'Day'
  }
  {
    exportSchedule: gcpLBExportsScheduleName
    exportDescription: 'Daily GCP unused Load Balancers exports'
    exportTimeOffset: 'PT4H09M'
    exportFrequency: 'Day'
  }
]
var csvExports = [
  ...
  // New Azure export: VMs underutilized off-hours
  {
    runbookName: vmOffHoursExportsRunbookName
    isOneToMany: false
    containerName: 'vmoffhoursexports'
    variableName: 'AzureOptimization_VMOffHoursContainer'
    variableDescription: 'The Storage Account container where VM off-hours underutilization exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestVMOffHoursDaily'
    ingestDescription: 'Daily VM off-hours underutilization ingests'
    ingestTimeOffset: 'PT2H08M'
    ingestFrequency: 'Day'
    ingestJobId: vmOffHoursIngestJobId
    exportSchedule: vmOffHoursExportsScheduleName
    exportJobId: vmOffHoursExportJobId
  }
  // AWS Data Collection exports
  {
    runbookName: awsEC2ExportsRunbookName
    isOneToMany: false
    containerName: 'awsec2exports'
    variableName: 'AzureOptimization_AWSEC2Container'
    variableDescription: 'The Storage Account container where AWS EC2 underutilized instances exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSEC2Daily'
    ingestDescription: 'Daily AWS EC2 underutilized instances ingests'
    ingestTimeOffset: 'PT3H30M'
    ingestFrequency: 'Day'
    ingestJobId: awsEC2IngestJobId
    exportSchedule: awsEC2ExportsScheduleName
    exportJobId: awsEC2ExportJobId
  }
  {
    runbookName: awsEBSUnattachedExportsRunbookName
    isOneToMany: false
    containerName: 'awsebsunattachedexports'
    variableName: 'AzureOptimization_AWSEBSUnattachedContainer'
    variableDescription: 'The Storage Account container where AWS unattached EBS volumes exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSEBSUnattachedDaily'
    ingestDescription: 'Daily AWS unattached EBS volumes ingests'
    ingestTimeOffset: 'PT3H31M'
    ingestFrequency: 'Day'
    ingestJobId: awsEBSUnattachedIngestJobId
    exportSchedule: awsEBSUnattachedExportsScheduleName
    exportJobId: awsEBSUnattachedExportJobId
  }
  {
    runbookName: awsEBSUnderutilizedExportsRunbookName
    isOneToMany: false
    containerName: 'awsebsunderutilizedexports'
    variableName: 'AzureOptimization_AWSEBSUnderutilizedContainer'
    variableDescription: 'The Storage Account container where AWS underutilized EBS volumes exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSEBSUnderutilizedDaily'
    ingestDescription: 'Daily AWS underutilized EBS volumes ingests'
    ingestTimeOffset: 'PT3H32M'
    ingestFrequency: 'Day'
    ingestJobId: awsEBSUnderutilizedIngestJobId
    exportSchedule: awsEBSUnderutilizedExportsScheduleName
    exportJobId: awsEBSUnderutilizedExportJobId
  }
  {
    runbookName: awsEIPExportsRunbookName
    isOneToMany: false
    containerName: 'awseipexports'
    variableName: 'AzureOptimization_AWSEIPContainer'
    variableDescription: 'The Storage Account container where AWS unattached EIPs exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSEIPDaily'
    ingestDescription: 'Daily AWS unattached EIPs ingests'
    ingestTimeOffset: 'PT3H33M'
    ingestFrequency: 'Day'
    ingestJobId: awsEIPIngestJobId
    exportSchedule: awsEIPExportsScheduleName
    exportJobId: awsEIPExportJobId
  }
  {
    runbookName: awsRDSExportsRunbookName
    isOneToMany: false
    containerName: 'awsrdsexports'
    variableName: 'AzureOptimization_AWSRDSContainer'
    variableDescription: 'The Storage Account container where AWS underutilized RDS instances exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSRDSDaily'
    ingestDescription: 'Daily AWS underutilized RDS instances ingests'
    ingestTimeOffset: 'PT3H34M'
    ingestFrequency: 'Day'
    ingestJobId: awsRDSIngestJobId
    exportSchedule: awsRDSExportsScheduleName
    exportJobId: awsRDSExportJobId
  }
  {
    runbookName: awsLBExportsRunbookName
    isOneToMany: false
    containerName: 'awslbexports'
    variableName: 'AzureOptimization_AWSLBContainer'
    variableDescription: 'The Storage Account container where AWS underutilized Load Balancers exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSLBDaily'
    ingestDescription: 'Daily AWS underutilized Load Balancers ingests'
    ingestTimeOffset: 'PT3H35M'
    ingestFrequency: 'Day'
    ingestJobId: awsLBIngestJobId
    exportSchedule: awsLBExportsScheduleName
    exportJobId: awsLBExportJobId
  }
  {
    runbookName: awsLambdaExportsRunbookName
    isOneToMany: false
    containerName: 'awslambdaexports'
    variableName: 'AzureOptimization_AWSLambdaContainer'
    variableDescription: 'The Storage Account container where AWS idle Lambda functions exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSLambdaDaily'
    ingestDescription: 'Daily AWS idle Lambda functions ingests'
    ingestTimeOffset: 'PT3H36M'
    ingestFrequency: 'Day'
    ingestJobId: awsLambdaIngestJobId
    exportSchedule: awsLambdaExportsScheduleName
    exportJobId: awsLambdaExportJobId
  }
  {
    runbookName: awsECSExportsRunbookName
    isOneToMany: false
    containerName: 'awsecsexports'
    variableName: 'AzureOptimization_AWSECSContainer'
    variableDescription: 'The Storage Account container where AWS idle ECS services exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSECSDaily'
    ingestDescription: 'Daily AWS idle ECS services ingests'
    ingestTimeOffset: 'PT3H37M'
    ingestFrequency: 'Day'
    ingestJobId: awsECSIngestJobId
    exportSchedule: awsECSExportsScheduleName
    exportJobId: awsECSExportJobId
  }
  {
    runbookName: awsElasticBeanstalkExportsRunbookName
    isOneToMany: false
    containerName: 'awselasticbeanstalkexports'
    variableName: 'AzureOptimization_AWSElasticBeanstalkContainer'
    variableDescription: 'The Storage Account container where AWS idle Elastic Beanstalk environments exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSElasticBeanstalkDaily'
    ingestDescription: 'Daily AWS idle Elastic Beanstalk environments ingests'
    ingestTimeOffset: 'PT3H38M'
    ingestFrequency: 'Day'
    ingestJobId: awsElasticBeanstalkIngestJobId
    exportSchedule: awsElasticBeanstalkExportsScheduleName
    exportJobId: awsElasticBeanstalkExportJobId
  }
  {
    runbookName: awsBucketsExportsRunbookName
    isOneToMany: false
    containerName: 'awsbucketsexports'
    variableName: 'AzureOptimization_AWSBucketsContainer'
    variableDescription: 'The Storage Account container where AWS buckets without retention exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestAWSBucketsDaily'
    ingestDescription: 'Daily AWS buckets without retention ingests'
    ingestTimeOffset: 'PT3H39M'
    ingestFrequency: 'Day'
    ingestJobId: awsBucketsIngestJobId
    exportSchedule: awsBucketsExportsScheduleName
    exportJobId: awsBucketsExportJobId
  }
  // GCP Data Collection exports
  {
    runbookName: gcpVMsExportsRunbookName
    isOneToMany: false
    containerName: 'gcpvmsexports'
    variableName: 'AzureOptimization_GCPVMsContainer'
    variableDescription: 'The Storage Account container where GCP underutilized VMs exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPVMsDaily'
    ingestDescription: 'Daily GCP underutilized VMs ingests'
    ingestTimeOffset: 'PT4H30M'
    ingestFrequency: 'Day'
    ingestJobId: gcpVMsIngestJobId
    exportSchedule: gcpVMsExportsScheduleName
    exportJobId: gcpVMsExportJobId
  }
  {
    runbookName: gcpVMsOffHoursExportsRunbookName
    isOneToMany: false
    containerName: 'gcpvmsoffhoursexports'
    variableName: 'AzureOptimization_GCPVMsOffHoursContainer'
    variableDescription: 'The Storage Account container where GCP underutilized VMs off-hours exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPVMsOffHoursDaily'
    ingestDescription: 'Daily GCP underutilized VMs off-hours ingests'
    ingestTimeOffset: 'PT4H31M'
    ingestFrequency: 'Day'
    ingestJobId: gcpVMsOffHoursIngestJobId
    exportSchedule: gcpVMsOffHoursExportsScheduleName
    exportJobId: gcpVMsOffHoursExportJobId
  }
  {
    runbookName: gcpIdleDisksExportsRunbookName
    isOneToMany: false
    containerName: 'gcpidledisksexports'
    variableName: 'AzureOptimization_GCPIdleDisksContainer'
    variableDescription: 'The Storage Account container where GCP idle disks exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPIdleDisksDaily'
    ingestDescription: 'Daily GCP idle disks ingests'
    ingestTimeOffset: 'PT4H32M'
    ingestFrequency: 'Day'
    ingestJobId: gcpIdleDisksIngestJobId
    exportSchedule: gcpIdleDisksExportsScheduleName
    exportJobId: gcpIdleDisksExportJobId
  }
  {
    runbookName: gcpUnderutilizedDisksExportsRunbookName
    isOneToMany: false
    containerName: 'gcpunderutilizeddisksexports'
    variableName: 'AzureOptimization_GCPUnderutilizedDisksContainer'
    variableDescription: 'The Storage Account container where GCP underutilized disks exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPUnderutilizedDisksDaily'
    ingestDescription: 'Daily GCP underutilized disks ingests'
    ingestTimeOffset: 'PT4H33M'
    ingestFrequency: 'Day'
    ingestJobId: gcpUnderutilizedDisksIngestJobId
    exportSchedule: gcpUnderutilizedDisksExportsScheduleName
    exportJobId: gcpUnderutilizedDisksExportJobId
  }
  {
    runbookName: gcpUnmanagedDisksExportsRunbookName
    isOneToMany: false
    containerName: 'gcpunmanageddisksexports'
    variableName: 'AzureOptimization_GCPUnmanagedDisksContainer'
    variableDescription: 'The Storage Account container where GCP unmanaged disks exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPUnmanagedDisksDaily'
    ingestDescription: 'Daily GCP unmanaged disks ingests'
    ingestTimeOffset: 'PT4H34M'
    ingestFrequency: 'Day'
    ingestJobId: gcpUnmanagedDisksIngestJobId
    exportSchedule: gcpUnmanagedDisksExportsScheduleName
    exportJobId: gcpUnmanagedDisksExportJobId
  }
  {
    runbookName: gcpIdleServicesExportsRunbookName
    isOneToMany: false
    containerName: 'gcpidleservicesexports'
    variableName: 'AzureOptimization_GCPIdleServicesContainer'
    variableDescription: 'The Storage Account container where GCP idle services exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPIdleServicesDaily'
    ingestDescription: 'Daily GCP idle services ingests'
    ingestTimeOffset: 'PT4H35M'
    ingestFrequency: 'Day'
    ingestJobId: gcpIdleServicesIngestJobId
    exportSchedule: gcpIdleServicesExportsScheduleName
    exportJobId: gcpIdleServicesExportJobId
  }
  {
    runbookName: gcpUnattachedIPsExportsRunbookName
    isOneToMany: false
    containerName: 'gcpunattachedipsexports'
    variableName: 'AzureOptimization_GCPUnattachedIPsContainer'
    variableDescription: 'The Storage Account container where GCP unattached IPs exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPUnattachedIPsDaily'
    ingestDescription: 'Daily GCP unattached IPs ingests'
    ingestTimeOffset: 'PT4H36M'
    ingestFrequency: 'Day'
    ingestJobId: gcpUnattachedIPsIngestJobId
    exportSchedule: gcpUnattachedIPsExportsScheduleName
    exportJobId: gcpUnattachedIPsExportJobId
  }
  {
    runbookName: gcpSQLExportsRunbookName
    isOneToMany: false
    containerName: 'gcpsqlexports'
    variableName: 'AzureOptimization_GCPSQLContainer'
    variableDescription: 'The Storage Account container where GCP underutilized Cloud SQL exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPSQLDaily'
    ingestDescription: 'Daily GCP underutilized Cloud SQL ingests'
    ingestTimeOffset: 'PT4H37M'
    ingestFrequency: 'Day'
    ingestJobId: gcpSQLIngestJobId
    exportSchedule: gcpSQLExportsScheduleName
    exportJobId: gcpSQLExportJobId
  }
  {
    runbookName: gcpBucketsExportsRunbookName
    isOneToMany: false
    containerName: 'gcpbucketsexports'
    variableName: 'AzureOptimization_GCPBucketsContainer'
    variableDescription: 'The Storage Account container where GCP buckets without retention exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPBucketsDaily'
    ingestDescription: 'Daily GCP buckets without retention ingests'
    ingestTimeOffset: 'PT4H38M'
    ingestFrequency: 'Day'
    ingestJobId: gcpBucketsIngestJobId
    exportSchedule: gcpBucketsExportsScheduleName
    exportJobId: gcpBucketsExportJobId
  }
  {
    runbookName: gcpLBExportsRunbookName
    isOneToMany: false
    containerName: 'gcplbexports'
    variableName: 'AzureOptimization_GCPLBContainer'
    variableDescription: 'The Storage Account container where GCP unused Load Balancers exports are dumped to'
    ingestSchedule: 'AzureOptimization_IngestGCPLBDaily'
    ingestDescription: 'Daily GCP unused Load Balancers ingests'
    ingestTimeOffset: 'PT4H39M'
    ingestFrequency: 'Day'
    ingestJobId: gcpLBIngestJobId
    exportSchedule: gcpLBExportsScheduleName
    exportJobId: gcpLBExportJobId
  }
  {
    runbookName: gcpFOCUSIngestRunbookName
    isOneToMany: true
    containerName: 'gcpfocusexports'
    variableName: 'AzureOptimization_GCPFOCUSContainer'
    variableDescription: 'The Storage Account container where GCP FOCUS data exports are dumped to'
    ingestSchedule: gcpFOCUSIngestScheduleName
    ingestDescription: 'Daily GCP FOCUS ingests'
    ingestTimeOffset: 'PT4H40M'
    ingestFrequency: 'Day'
    ingestJobId: gcpFOCUSIngestJobId
    exportSchedule: null
    exportJobId: 'dummy'
  }
]
...
var recommendations = [
  ...
  // AWS Recommendations
  {
    recommendationJobId: awsEC2RecommendationJobId
    runbookName: awsEC2RecommendationsRunbookName
  }
  {
    recommendationJobId: awsEBSUnattachedRecommendationJobId
    runbookName: awsEBSUnattachedRecommendationsRunbookName
  }
  {
    recommendationJobId: awsEBSUnderutilizedRecommendationJobId
    runbookName: awsEBSUnderutilizedRecommendationsRunbookName
  }
  {
    recommendationJobId: awsEIPRecommendationJobId
    runbookName: awsEIPRecommendationsRunbookName
  }
  {
    recommendationJobId: awsRDSRecommendationJobId
    runbookName: awsRDSRecommendationsRunbookName
  }
  {
    recommendationJobId: awsLBRecommendationJobId
    runbookName: awsLBRecommendationsRunbookName
  }
  {
    recommendationJobId: awsLambdaRecommendationJobId
    runbookName: awsLambdaRecommendationsRunbookName
  }
  {
    recommendationJobId: awsECSRecommendationJobId
    runbookName: awsECSRecommendationsRunbookName
  }
  {
    recommendationJobId: awsElasticBeanstalkRecommendationJobId
    runbookName: awsElasticBeanstalkRecommendationsRunbookName
  }
  {
    recommendationJobId: awsBucketsRecommendationJobId
    runbookName: awsBucketsRecommendationsRunbookName
  }
  // GCP Recommendations
  {
    recommendationJobId: gcpVMsRecommendationJobId
    runbookName: gcpVMsRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpVMsOffHoursRecommendationJobId
    runbookName: gcpVMsOffHoursRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpIdleDisksRecommendationJobId
    runbookName: gcpIdleDisksRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpUnderutilizedDisksRecommendationJobId
    runbookName: gcpUnderutilizedDisksRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpSQLRecommendationJobId
    runbookName: gcpSQLRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpIdleServicesRecommendationJobId
    runbookName: gcpIdleServicesRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpUnattachedIPsRecommendationJobId
    runbookName: gcpUnattachedIPsRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpLBRecommendationJobId
    runbookName: gcpLBRecommendationsRunbookName
  }
  {
    recommendationJobId: gcpBucketsRecommendationJobId
    runbookName: gcpBucketsRecommendationsRunbookName
  }
  // New Azure Recommendations
  {
    recommendationJobId: underutilizedVMsRecommendationJobId
    runbookName: underutilizedVMsRecommendationsRunbookName
  }
  {
    recommendationJobId: unmanagedDisksRecommendationJobId
    runbookName: unmanagedDisksRecommendationsRunbookName
  }
  {
    recommendationJobId: vmOffHoursRecommendationJobId
    runbookName: vmOffHoursRecommendationsRunbookName
  }
]
...
var runbooks = [
  ...
  // New Azure export runbook
  {
    name: vmOffHoursExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports VM off-hours underutilization data to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/${vmOffHoursExportsRunbookName}.ps1')
  }
  // AWS Data Collection runbooks
  {
    name: awsEC2ExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS EC2 underutilized instances to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsEC2ExportsRunbookName}.ps1')
  }
  {
    name: awsEBSUnattachedExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS unattached EBS volumes to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsEBSUnattachedExportsRunbookName}.ps1')
  }
  {
    name: awsEBSUnderutilizedExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS underutilized EBS volumes to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsEBSUnderutilizedExportsRunbookName}.ps1')
  }
  {
    name: awsEIPExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS unattached EIPs to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsEIPExportsRunbookName}.ps1')
  }
  {
    name: awsRDSExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS underutilized RDS instances to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsRDSExportsRunbookName}.ps1')
  }
  {
    name: awsLBExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS underutilized Load Balancers to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsLBExportsRunbookName}.ps1')
  }
  {
    name: awsLambdaExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS idle Lambda functions to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsLambdaExportsRunbookName}.ps1')
  }
  {
    name: awsECSExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS idle ECS services to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsECSExportsRunbookName}.ps1')
  }
  {
    name: awsElasticBeanstalkExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS idle Elastic Beanstalk environments to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsElasticBeanstalkExportsRunbookName}.ps1')
  }
  {
    name: awsBucketsExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports AWS buckets without retention policy to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/aws/${awsBucketsExportsRunbookName}.ps1')
  }
  // GCP Data Collection runbooks
  {
    name: gcpVMsExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP underutilized VMs to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpVMsExportsRunbookName}.ps1')
  }
  {
    name: gcpVMsOffHoursExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP underutilized VMs off-hours to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpVMsOffHoursExportsRunbookName}.ps1')
  }
  {
    name: gcpIdleDisksExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP idle disks to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpIdleDisksExportsRunbookName}.ps1')
  }
  {
    name: gcpUnderutilizedDisksExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP underutilized disks to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpUnderutilizedDisksExportsRunbookName}.ps1')
  }
  {
    name: gcpUnmanagedDisksExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP unmanaged disks to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpUnmanagedDisksExportsRunbookName}.ps1')
  }
  {
    name: gcpIdleServicesExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP idle services to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpIdleServicesExportsRunbookName}.ps1')
  }
  {
    name: gcpUnattachedIPsExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP unattached IPs to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpUnattachedIPsExportsRunbookName}.ps1')
  }
  {
    name: gcpSQLExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP underutilized Cloud SQL instances to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpSQLExportsRunbookName}.ps1')
  }
  {
    name: gcpBucketsExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP buckets without retention policy to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpBucketsExportsRunbookName}.ps1')
  }
  {
    name: gcpLBExportsRunbookName
    version: '1.0.0.0'
    description: 'Exports GCP unused Load Balancers to Blob Storage'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpLBExportsRunbookName}.ps1')
  }
  {
    name: gcpFOCUSIngestRunbookName
    version: '1.0.0.0'
    description: 'Ingests GCP FOCUS data into Log Analytics'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/data-collection/gcp/${gcpFOCUSIngestRunbookName}.ps1')
  }
  // AWS Recommendation runbooks
  {
    name: awsEC2RecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS EC2 underutilized instances recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsEC2RecommendationsRunbookName}.ps1')
  }
  {
    name: awsEBSUnattachedRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS unattached EBS volumes recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsEBSUnattachedRecommendationsRunbookName}.ps1')
  }
  {
    name: awsEBSUnderutilizedRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS underutilized EBS volumes recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsEBSUnderutilizedRecommendationsRunbookName}.ps1')
  }
  {
    name: awsEIPRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS unattached EIPs recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsEIPRecommendationsRunbookName}.ps1')
  }
  {
    name: awsRDSRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS underutilized RDS instances recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsRDSRecommendationsRunbookName}.ps1')
  }
  {
    name: awsLBRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS underutilized Load Balancers recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsLBRecommendationsRunbookName}.ps1')
  }
  {
    name: awsLambdaRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS idle Lambda functions recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsLambdaRecommendationsRunbookName}.ps1')
  }
  {
    name: awsECSRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS idle ECS services recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsECSRecommendationsRunbookName}.ps1')
  }
  {
    name: awsElasticBeanstalkRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS idle Elastic Beanstalk environments recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsElasticBeanstalkRecommendationsRunbookName}.ps1')
  }
  {
    name: awsBucketsRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates AWS buckets without retention policy recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/aws/${awsBucketsRecommendationsRunbookName}.ps1')
  }
  // GCP Recommendation runbooks
  {
    name: gcpVMsRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP underutilized VMs recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpVMsRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpVMsOffHoursRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP underutilized VMs off-hours recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpVMsOffHoursRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpIdleDisksRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP idle disks recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpIdleDisksRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpUnderutilizedDisksRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP underutilized disks recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpUnderutilizedDisksRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpSQLRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP underutilized Cloud SQL recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpSQLRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpIdleServicesRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP idle services recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpIdleServicesRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpUnattachedIPsRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP unattached IPs recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpUnattachedIPsRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpLBRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP unused Load Balancers recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpLBRecommendationsRunbookName}.ps1')
  }
  {
    name: gcpBucketsRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates GCP buckets without retention policy recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/gcp/${gcpBucketsRecommendationsRunbookName}.ps1')
  }
  // New Azure Recommendation runbooks
  {
    name: underutilizedVMsRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates underutilized VMs recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/${underutilizedVMsRecommendationsRunbookName}.ps1')
  }
  {
    ...
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/${unmanagedDisksRecommendationsRunbookName}.ps1')
  }
  {
    name: vmOffHoursRecommendationsRunbookName
    version: '1.0.0.0'
    description: 'Generates VM off-hours underutilization recommendations'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/recommendations/${vmOffHoursRecommendationsRunbookName}.ps1')
  }
  // Orchestrator runbook
  {
    name: distributorOrchestratorRunbookName
    version: '1.0.0.0'
    description: 'Triggers the Optimization Engine Distributor orchestrator'
    type: 'PowerShell'
    scriptUri: uri(templateLocation, 'runbooks/orchestration/${distributorOrchestratorRunbookName}.ps1')
  }
]
var automationVariables = [
  ...
  {
    name: 'AzureOptimization_BillingAccountID'
    description: 'The Billing Account ID for cost data exports (EA enrollment number or MCA billing account ID)'
    value: '"${billingAccountId}"'
  }
  {
    name: 'AzureOptimization_BillingProfileID'
    description: 'The Billing Profile ID for MCA cost data exports (leave empty for EA)'
    value: '"${billingProfileId}"'
  }
  {
    name: 'AzureOptimization_ConsumptionScope'
    description: 'The scope for consumption data exports (Subscription or BillingAccount)'
  ...
  // AWS/GCP feature flags and configuration
  {
    name: 'AzureOptimization_AWSEnabled'
    description: 'Whether AWS data collection is enabled'
    value: '"false"'
  }
  {
    name: 'AzureOptimization_GCPEnabled'
    description: 'Whether GCP data collection is enabled'
    value: '"false"'
  }
  {
    name: 'AzureOptimization_AwsExportsContainer'
    description: 'The Storage Account container used for AWS exports staging'
    value: '"awsexports"'
  }
  {
    name: 'AzureOptimization_GcpExportsContainer'
    description: 'The Storage Account container used for GCP exports staging'
    value: '"gcpexports"'
  }
  {
    name: 'AzureOptimization_DistributorVmName'
    description: 'The name of the distributor VM used to run AWS/GCP collection scripts'
    value: '""'
  }
  {
    name: 'AzureOptimization_DistributorVmRG'
    description: 'The resource group of the distributor VM'
    value: '""'
  }
  {
    name: 'AzureOptimization_DistributorVmLocation'
    description: 'The location/region of the distributor VM'
    value: '"${projectLocation}"'
  }
  {
    name: 'AzureOptimization_AWSScriptsPath'
    description: 'The local path on the distributor VM where AWS collection scripts are stored'
    value: '""'
  }
  {
    name: 'AzureOptimization_GCPScriptsPath'
    description: 'The local path on the distributor VM where GCP collection scripts are stored'
    value: '""'
  }
]
...
resource defaultTelemetry 'Microsoft.Resources/deployments@2022-09-01' = if (enableDefaultTelemetry) {
  ...
  properties: {
    ...
    template: {
      ...
      metadata: {
        _generator: {
          name: 'RAVLs Optimization Engine'
