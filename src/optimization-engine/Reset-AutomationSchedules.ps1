<#
.SYNOPSIS
This script resets the RAVLs Optimization Engine schedules to a new base time and optionally changes the Hybrid Worker Group for all schedules.
...
if ($weeklySchedules.Count -gt 0) {
    ...
    throw "The $AutomationAccountName Automation Account does not contain RAVLs Optimization Engine schedules."
}
